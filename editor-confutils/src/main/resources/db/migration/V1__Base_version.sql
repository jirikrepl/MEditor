...
CREATE TABLE tree_structure_node (
  id                         INTEGER DEFAULT nextval('seq_tree_structure_node') NOT NULL,
...
CREATE TABLE request_to_admin (
  id                   INTEGER DEFAULT nextval('seq_request_to_admin') NOT NULL,
...
CREATE TABLE tree_structure (
  id                         INTEGER DEFAULT nextval('seq_tree_structure') NOT NULL,
...
CREATE TABLE saved_edited_object (
  id                  INTEGER DEFAULT nextval('seq_saved_edited_object') NOT NULL,
  digital_object_uuid CHARACTER VARYING(45)                                          NOT NULL,
...
CREATE TABLE lock (
  id                  INTEGER DEFAULT nextval('seq_lock') NOT NULL,
  digital_object_uuid CHARACTER VARYING(45)                           NOT NULL,
  description         CHARACTER VARYING(16000),
  state               BOOLEAN DEFAULT 'true'                          NOT NULL,
  PRIMARY KEY (id)
...
CREATE TABLE editor_user (
  id      INTEGER DEFAULT nextval('seq_editor_user') NOT NULL,
