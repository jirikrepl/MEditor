...
public class SecuredFedoraAccessImpl
    ...
    /*
     * (non-Javadoc)
     * @see cz.mzk.editor.server.fedora.FedoraAccess#getAPIA()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see cz.mzk.editor.server.fedora.FedoraAccess#getAPIM()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.fedora.FedoraAccess#getFOXMLInputStream
     * (java.lang.String)
     */
    @Override
