...
import static cz.mzk.editor.client.util.Constants.DATASTREAM_ID.RELS_EXT;
import static cz.mzk.editor.client.util.Constants.DATASTREAM_ID.TEXT_OCR;
import static cz.mzk.editor.server.fedora.utils.FoxmlUtils.LABEL_VALUE;
...
import static cz.mzk.editor.shared.domain.FedoraNamespaces.RELS_EXT_NAMESPACE_URI;
