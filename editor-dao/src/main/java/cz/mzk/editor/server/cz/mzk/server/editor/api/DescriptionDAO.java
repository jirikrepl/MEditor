...
public interface DescriptionDAO {
    ...
    boolean putUserDescription(String uuid, String description, Long userId) throws DatabaseException;
    ...
    String  getUserDescription(String uuid, Long userId) throws DatabaseException;
}
